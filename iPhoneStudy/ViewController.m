...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text = [dayPromptList objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIViewController *detail = [self.storyboard instantiateViewControllerWithIdentifier:[dayList objectAtIndex:indexPath.row]];
    detail.navigationItem.Title = [dayList objectAtIndex:indexPath.row];
    detail.navigationItem.Prompt = [dayPromptList objectAtIndex:indexPath.row];
